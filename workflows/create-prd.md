---
name: create-prd
description: Creates a comprehensive Product Requirements Document from conversation context. Use when the user asks to generate a PRD, create product requirements, or document feature specifications from a discussion.
